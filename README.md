# 📊 Nigeria Kidnapping Dataset Analysis

## 📌 Project Overview
This project analyzes kidnapping incidents in Nigeria using a structured dataset. The aim is to uncover patterns, trends, and relationships within the data to provide meaningful insights that can support academic research, policy-making, and data-driven decision-making.
...
- **Date of Incident** – When the event occurred  
- **Location (State/Region)** – Where the incident took place  
- **Number of Cases** – Reported kidnapping cases  
- **Other Variables** – Additional relevant information depending on the dataset  
...
- **Trend Analysis**  
  Examining how kidnapping incidents change over time  
